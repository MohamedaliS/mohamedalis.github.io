# Mohammed Ali Sharafuddin Website
...
- Personal homepage and contact entry points
...
- `index.html`: homepage
- `about.html`: public profile page
- `research.html`: publications and research outputs
